...
class AnchorWithdraw(WithdrawalIntegration):
    ...
    def interactive_url(
        ...
        **kwargs: Dict,
        ...
        payload = {'type': 'withdraw', 'asset_code': asset.code, 'transaction_id':transaction.id, 'token': token, 'wallet': transaction.stellar_account}
    ...
    def after_interactive_flow(
        ...
        transaction.receiving_anchor_account = "GAQKDKLJUIDWJUB3PMINBCOH6TJWELQML7LLYY7OJ3Z6XXMGJQ53L6V5"
        transaction.save()
